...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\telebat\public\storage' => 'string',
            ...
            'firebase.projects.app.storage.default_bucket' => 'string',
            ...
            'firebase.credentials.file' => 'string',
            'firebase.database.default.url' => 'string',
            'firebase.storage.default.bucket' => 'string',
            ...
            'sms.gateway.url' => 'string',
            'sms.gateway.api_key' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\telebat\\public\\storage','firebase.default','firebase.projects.app.credentials',
...
'firebase.projects.app.http_client_options.guzzle_middlewares','firebase.credentials.file','firebase.database.default.url','firebase.storage.default.bucket','l5-swagger.default',
...
'session.http_only','session.same_site','session.partitioned','sms.gateway.url','sms.gateway.api_key',
...
'password.update','profile.update','profile.destroy','register','verification.verify',
'verification.send','send.code','verify.code','password.email',
'password.store','password.reset','logout','storage.local',);
        registerArgumentsSet('views', 
'app','emails.otp','emails.password-change','emails.register','l5-swagger::index',
'vendor.l5-swagger.index','l5-swagger::index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','QUEUE_CONNECTION',
'SMS_GATEWAY_APIKEY','SMS_GATWAY_URL','FIREBASE_CREDENTIALS','FIREBASE_PROJECT_ID','FIREBASE_DATABASE_URL',
